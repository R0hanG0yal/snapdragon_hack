# Qualcomm AI Hub Compilation Job for whisper_base_en
...
compile_job = hub.submit_compile_job(
    model=model_name,
    device=device,
    options="--target_runtime qnn_lib_context --quantize int8_/_fp16"
)
...
target_model.download("whisper_base_en_snapdragon_x_elite.onnx")
